...
function generatePage(contentHtml, title, description, urlPath, image, showHero = true) {
  ...
  // Inject flexbox to push footer to bottom and add Mermaid loader styles
  topPart = topPart.replace('</head>', `
    ...
    <style>
      ...
      .mermaid:not([data-processed="true"]) {
        min-height: 250px;
        background: linear-gradient(90deg, var(--surface2) 0%, var(--border-mid) 50%, var(--surface2) 100%);
